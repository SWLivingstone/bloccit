...
RSpec.describe PostsController, type: :controller do
  ...
  describe "GET edit" do
    it "returns http success" do
      get :edit, topic_id: my_topic.id, id: not_my_post.id
      expect(response).to have_http_status(:success)
    end
    ...
    it "assigns post to be updated to @post" do
      ...
      expect(post_instance.id).to eq not_my_post.id
      expect(post_instance.title).to eq not_my_post.title
      expect(post_instance.body).to eq not_my_post.body
    end
  end
  ...
  describe "PUT update" do
    it "updates post with expected attributes" do
      ...
      expect(updated_post.id).to eq not_my_post.id
  ...
  describe "DELETE destroy" do
    it "deletes the post" do
      ...
      count = Post.where({id: not_my_post.id}).size
...
context "signed-in member who owns post" do
  before do
    my_user.member!
    create_session(my_user)
  end
...
context "signed-in member who does not own post" do
  before do
    my_user.member!
    create_session(my_user)
  end
  ...
  describe "GET show" do
    it "returns http success" do
      get :show, topic_id: my_topic.id, id: not_my_post.id
      expect(response).to have_http_status(:success)
    end
    it "renders the #show view" do
      get :show, topic_id: my_topic.id, id: not_my_post.id
    ...
    it "assigns not_my_post to @post" do
      get :show, topic_id: my_topic.id, id: not_my_post.id
      expect(assigns(:post)).to eq(not_my_post)
    end
  end
...
describe "GET edit" do
  it "returns redirect to [not_my_post.topic, not_my_post]" do
    get :edit, topic_id: my_topic.id, id: not_my_post.id
    expect(response).to redirect_to [not_my_post.topic, not_my_post]
  end
end
